...
for i in $(seq 1 $num); do
    java -cp /home/ubuntu/.m2/repository/com/hazelcast/hazelcast/3.8.6/hazelcast-3.8.6.jar:/home/ubuntu/java/imperative/hazelcast-client-3.8.6.jar:. main2 $1 >$i &>$i &
done
...
target="/home/ubuntu/java/imperative/target/classes"
acc=0
n_times=0
for j in "$target"/*
do
